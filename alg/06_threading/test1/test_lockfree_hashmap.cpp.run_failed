...
void test_lockfree_hashmap_basic()
{
    ...
    std::cout << "\nconcept0 : " << alg::LT8BYTES<std::uint32_t>;
    std::cout << "\nconcept0 : " << alg::LT8BYTES<std::uint64_t>;
    std::cout << "\nconcept0 : " << alg::LT8BYTES<A>;
    std::cout << "\nconcept0 : " << alg::LT8BYTES<B>;
    std::cout << "\nconcept0 : " << alg::LT8BYTES<C>;
    std::cout << "\nconcept1 : " << alg::TO8BYTES<F0,A>;
    std::cout << "\nconcept1 : " << alg::TO8BYTES<F1,A>;
    std::cout << "\nconcept1 : " << alg::TO8BYTES<F2,A>;
    std::cout << "\n";
    ...
    alg::lockfree_hashmap<A,B,HA,HB,16> map;
...
{
    alg::lockfree_hashmap<A,B,HA,HB,NUM_CELLS> map;
