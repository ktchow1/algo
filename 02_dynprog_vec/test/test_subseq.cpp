...
void test_subseq_sum()
{
    ...
    benchmark<1>("test max_subseq_sum",           
    ...
    benchmark<1>("test count_target_subseq_sum",           
    ...
    benchmark<1>("test count_less_than_target_subseq_prd", 
