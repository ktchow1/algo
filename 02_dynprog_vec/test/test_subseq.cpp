...
void test_subseq_sum()
{
    ...
    benchmark_vec_with_target("count_less_than_target_subseq_prd", 
                              gen_random_vec<std::uint32_t>, 
