...
void test_stack_problem()
{
    ...
    benchmark<1>("test shortest_unsorted_subseq",           
    ...
    benchmark<1>("test count_stroke_in_histogram",           
    ...
    benchmark<1>("test biggest_rect_in_hist",           
    ...
    benchmark<1>("test total_trapped_water",           
